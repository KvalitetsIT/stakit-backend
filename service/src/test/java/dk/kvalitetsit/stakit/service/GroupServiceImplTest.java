...
public class GroupServiceImplTest {
    ...
    public void testGetAllGroups() {
        var groupOne = new GroupConfigurationEntity(1L, UUID.randomUUID(), "name 1", 10, "description 1", true, true);
        var groupTwo = new GroupConfigurationEntity(1L, UUID.randomUUID(), "name 2", 20, "description 2", true, true);
    ...
    public void testCreateGroup() {
        var input = GroupModel.createInstance("name", 10, "description", Collections.emptyList(), true, true);

        var result = groupService.createGroup(input);
        assertNotNull(result);

        Mockito.verify(groupDao, times(1)).insert(GroupConfigurationEntity.createInstance(result, input.name(), input.displayOrder(), input.description(), true, true));
    }

    @Test
    public void testCreateGroupWithServices() {
        var input = GroupModel.createInstance("name", 10, "description", Collections.singletonList(UUID.randomUUID()), true, true);
    ...
    public void testCreateGroupWithServicesNotFound() {
        ...
        GroupConfigurationEntity groupConfiguration = new GroupConfigurationEntity(1L, UUID.randomUUID(), "name", 10, "description", true, true);
    ...
    public void testUpdateGroup() {
        var input = new GroupModel(UUID.randomUUID(), "name", 10, "description", Collections.emptyList(), true, true);

        var daoInput = GroupConfigurationEntity.createInstance(input.uuid(), input.name(), input.displayOrder(), input.description(), true, true);
    ...
    public void testUpdateGroupWithServices() {
        var input = new GroupModel(UUID.randomUUID(), "name", 10, "description", Collections.singletonList(UUID.randomUUID()), true, true);
        ...
        Mockito.when(serviceConfigurationDao.findByUuidWithGroupUuid(serviceConfiguration.uuid())).thenReturn(Optional.of(serviceConfiguration));
        Mockito.when(groupDao.update(daoInput)).thenReturn(true);
        Mockito.when(groupDao.findByUuid(input.uuid())).thenReturn(Optional.of(new GroupConfigurationEntity(20L, input.uuid(), input.name(), input.displayOrder(), input.description(), true, true)));
    ...
    public void testFindGroup() {
        ...
        var groupConfigurationEntity = new GroupConfigurationEntity(10L, input, "name", 10, "description", true, true);
    ...
    public void testPatchGroup() {
        ...
        var group = new GroupConfigurationEntity(10L, uuidGroup, "some name", 10, "some description", true, true);
    ...
    public void testPatchGroupServiceNotFound() {
        ...
        var group = new GroupConfigurationEntity(10L, uuidGroup, "some name", 10, "description", true, true);
